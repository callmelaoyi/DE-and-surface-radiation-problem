...
class DE_gai(GeneticAlgorithmBase):
    ...
    def mutation(self, generation_best_index):
        # 变异操作
        '''
        ...
        self.V = X[generation_best_index, :] + self.F * (X[r2, :] - X[r3, :])
    ...
    def run(self, max_iter=None):
        ...
        return global_best_X, global_best_Y,  self.generation_best_X,self.generation_best_Y
